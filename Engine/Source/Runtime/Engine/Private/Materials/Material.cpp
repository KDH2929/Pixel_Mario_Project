	...
	bool bIsSupported)
{
	...
	else
	{
		...
		case MP_SubsurfaceColor:
			Active = ShadingModels.HasAnyShadingModel({ MSM_Subsurface, MSM_PreintegratedSkin, MSM_TwoSidedFoliage, MSM_Cloth, MSM_AniToon, MSM_AniToonUnlit });
			break;
		case MP_CustomData0:
			Active = ShadingModels.HasAnyShadingModel({ MSM_ClearCoat, MSM_Hair, MSM_Cloth, MSM_Eye, MSM_SubsurfaceProfile, MSM_AniToon, MSM_AniToonUnlit, MSM_Toon });
			break;
		case MP_CustomData1:
